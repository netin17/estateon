...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12 upl-image-area">
        <form action="{{ route('adminuser.property.addimage') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="card card-widget img-box"> 
            <div class="card-header">
                <div class="card-tools">
                    <a href="{{route('adminuser.property.deleteimage', $image->id)}}" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i>
                    </a>
                </div>
            </div>
            <!-- /.card-header -->

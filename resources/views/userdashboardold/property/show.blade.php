                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="">{{$amenity['amenity_data']['name'] ?? ''}}</span>
                            @endforeach
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="">{{ $data['property']->vastu['vastu_data']['name']  ?? ''}}</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="">{{ $preference['preferences_data']['name']  ?? ''}}</span>
                            @endforeach
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                        <div class="row">
                            @foreach($data['property']->images as $i)

...
<div class="profile-form-group d-flex align-items-center mb-4">
 ...
 <div class="form-group">
    ...
    <div class="form-check">
        <input type="radio" class="form-check-input" name="possesion_by" value="{{ $option }}" id="possession_{{ $option }}" {{ $data['property']->property_details->possesion_by == $option ? 'checked' : '' }}>
